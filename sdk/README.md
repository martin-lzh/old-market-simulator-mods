...
| 2.1.6 | [2.1.6/r7](2.1.6/r7/manifest.json) | Windows x64，Unity Mono 2022.3.62f3 | Navigation 0.2.1 继续固定此修订；罗马主城范围与统一缩放修复不增加接口，实机验收待完成。此前测试见 [验证记录](../releases/validation.md) |
