    ...
    public sealed class MapPoiLayer : IDisposable
    {
        ...
        private void Rebuild()
        {
            ...
            foreach(var poi in definition.Pois)
            {
                ...
                node.Icon.sprite=icons.TryGetValue(poi.Category??"",out var sprite)?sprite:icons["other"];
        ...
        public void Dispose(){Clear();foreach(var item in owned)if(item!=null)UnityEngine.Object.Destroy(item);owned.Clear();}
    }
}
