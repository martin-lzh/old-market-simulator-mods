...
{
    [BepInPlugin("local.oldmarket.navigation", "Map & Compass", "0.2.1")]
    ...
    public sealed class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Logger.LogInfo("Map & Compass 0.2.1 loaded. Map texture is optional; no scene cameras or additional regions are created.");
        }
